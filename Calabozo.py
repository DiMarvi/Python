import os
from DefCalabozo import *
from ClassCalabozo import *

os.system('cls' if os.name == 'nt' else 'clear')
'''Personaje'''
Char = Character(True,'Diana',0,0.1,0,50,0,0,1,['Pocion Vida Menor'],'Arco','Armadura de Cuero')
'''Monstros'''
Mos = ['','Slime','Snake','Wolf','Gigant wolf']
''''''
'''Ajustando'''
...
while Char.Alive:
    ...
    if Accion == 1: 
        ...
        SALA 3
        ______________________________________________________________
        print('Entras en la sala de la izquierda, atenta y te percatas de
        print('dos slimes: uno en el centro y otro en la esquina en el fondo a la
        print('derecha. Tienes que luchar contra ellos.
